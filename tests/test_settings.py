...
def test_load_settings_images_and_dashboards(mocker):
    ...
    dummy_settings = {
        ...
        "dashboards": {
            "dashboard1": {"image1": "test_image_1.jpg", "absent": [{"image": "absent_image.jpg"}]}
        },
        "events": {
            "event1": {
                "summary": [{"summary": "", "image": "event_image.jpg"}],
                "actions": [{"image": "action_image.jpg"}],
            },
            "event2": {"summary": "{button}", "actions": []},
        },
    }
    ...
    assert (
        settings["dashboards"]["dashboard1"]["absent"][0]["image"] == "/dummy/path/absent_image.jpg"
    )
